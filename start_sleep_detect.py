...
alarm_sound = mixer.Sound('danger_alarm.wav')
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if ratio >4.2:
                ...
                if blink_time_counter > 40:
                    utils.colorBackgroundText(frame,  f'Drowsy Driver Detected.WAKE UP!!', FONTS, 1, (int(frame_height/2), 100), 2, utils.RED, pad_x=6, pad_y=6, )
                    if not ALARM_ON:
                        ALARM_ON = True
                        # play alarm
                        alarm_sound.play()
            ...
            utils.colorBackgroundText(frame,  f'Blink Counter: {TOTAL_BLINKS}', FONTS, 0.7, (30,150),2)
        ...
        frame =utils.textWithBackground(frame,f'FPS: {round(fps,1) - 8}',FONTS, 1.0, (30, 50), bgOpacity=0.9, textThickness=2)
